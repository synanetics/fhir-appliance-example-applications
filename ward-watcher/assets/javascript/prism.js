/*
 * File: /assets/javascript/prism.js
 * Project: fhir-control
 * Created Date: Sunday June 13th 2021
 * Author: Rob Organ
 * -----
 * Last Modified: Sunday June 13th 2021 8:06:05 pm
            ...
            n = (_self.Prism = {
                ...
                highlightElement: function (t, a, r) {
                    ...
                    o && ((l = (o.className.match(e) || [, ""])[1].toLowerCase()), (i = n.languages[l])),
                        ...
                        t.parentNode &&
                            ((o = t.parentNode), /pre/i.test(o.nodeName) && (o.className = o.className.replace(e, "").replace(/\s+/g, " ") + " language-" + l));
                    var s = t.textContent,
                        u = {
                            element: t,
                            language: l,
